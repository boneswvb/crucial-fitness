            ...
            <ListGroup as="ul" style={{ textAlign: "center" }}>
              ...
              <ListGroup.Item as="li">
                <Link to="/lifeStyleasspage">
                  <p className="dropdown-item">
                    <strong>Life Style Assessment</strong>
                  </p>
                </Link>
              </ListGroup.Item>
              <ListGroup.Item as="li">
                <Link to="/generalhealthassessmentpage">
                  <p className="dropdown-item">
                    <strong>General Health Assessment</strong>
                  </p>
                </Link>
              </ListGroup.Item>
              <ListGroup.Item as="li">
      ...
      <Card style={{ width: "20rem", margin: "10px" }}>
        ...
        <Card.Body>
          ...
          <Card.Text>
            <ListGroup as="ul" style={{ textAlign: "center" }}>
              <ListGroup.Item as="li">
                <Link to="/coachingpage/individuelform">
                  <p className="dropdown-item">
              ...
              <ListGroup.Item as="li">
                <Link to="/coachingpage/groupform">
                  <p className="dropdown-item">
                    <strong>Group</strong>
                  </p>
                </Link>
              ...
              <ListGroup.Item as="li">
                <Link to="/coachingpage/rugbyform">
                  <p className="dropdown-item">
                    <strong>Rugby</strong>
                  </p>
                </Link>
              ...
              <ListGroup.Item as="li">
                <Link to="/coachingpage/netballform">
                  <p className="dropdown-item">
              ...
              <ListGroup.Item as="li">
                <Link to="/coachingpage/hockeyform">
                  <p className="dropdown-item">
