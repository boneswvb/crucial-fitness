        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          <Nav className="mr-auto">
            ...
            {userInfo.email === "admin@admin.com" && isSignedOn === true ? (
              <Nav.Link eventKey={47}>
                <Link to="/AdminUserProfile">AdminUserProfile</Link>
              </Nav.Link>
            ) : null}
            {userInfo.email !== "admin@admin.com" && isSignedOn === true ? (
              <Nav.Link eventKey={3}>
                <Link to="/Userprofilepage">Profile Page</Link>
              </Nav.Link>
            ) : null}
            <Nav.Link eventKey={46}>
              <Link to="/contactuspage">Contact</Link>
            </Nav.Link>
            <NavDropdown title="About" id="collasible-nav-dropdown">
              <NavDropdown.Item eventKey={4}>
                <Link to="/aboutpage/aboutform">All About Items</Link>
              </NavDropdown.Item>
              <NavDropdown.Divider />
              <NavDropdown.Item eventKey={5}>
                <Link to="/aboutpage/biographyform">Biography</Link>
              </NavDropdown.Item>
              <NavDropdown.Divider />
              <NavDropdown.Item eventKey={6}>
                <Link to="/aboutpage/missionvisionform">
              ...
              <NavDropdown.Item eventKey={8}>
                <Link to="/aboutpage/acceptanceform">Acceptance</Link>
              </NavDropdown.Item>
              <NavDropdown.Divider />
              <NavDropdown.Item eventKey={9}>
                <Link to="/aboutpage/waiverform">Waiver</Link>
              </NavDropdown.Item>
            </NavDropdown>
            {isSignedOn ? (
            ...
            <NavDropdown title="Interesting Reads" id="collasible-nav-dropdown">
              <NavDropdown.Item eventKey={13}>
                <Link to="/interestingreadspage/interestingreadsrorm">
                  Interesting Reads
                </Link>
              </NavDropdown.Item>
              <NavDropdown.Divider />
            ...
            <NavDropdown title="Coaching" id="collasible-nav-dropdown">
              <NavDropdown.Item>
                <Link to="/coachingpage/coachingform">Coaching</Link>
              </NavDropdown.Item>
              <NavDropdown.Divider />
              <NavDropdown.Item eventKey={22}>
                <Link to="/coachingpage/individuelform">Individuel</Link>
              </NavDropdown.Item>
              <NavDropdown.Divider />
              <NavDropdown.Item eventKey={23}>
                <Link to="/coachingpage/groupform">Group</Link>
              </NavDropdown.Item>
              <NavDropdown.Divider />
              <NavDropdown.Item eventKey={24}>
                <Link to="/coachingpage/generalfitnessform">
                  General Fitness
                </Link>
              </NavDropdown.Item>
              <NavDropdown.Divider />
              <NavDropdown.Item eventKey={25}>
                <Link to="/coachingpage/rugbyform">Rugby</Link>
              </NavDropdown.Item>
              <NavDropdown.Divider />
              <NavDropdown.Item eventKey={26}>
                <Link to="/coachingpage/netballform">Netball</Link>
              </NavDropdown.Item>
              <NavDropdown.Divider />
              <NavDropdown.Item eventKey={27}>
                <Link to="/coachingpage/hockeyform">Hockey</Link>
              </NavDropdown.Item>
            </NavDropdown>
            <NavDropdown title="Rehabilitation" id="collasible-nav-dropdown">
              <NavDropdown.Item eventKey={28}>
                <Link to="/rehabilitationpage/rehabilitationform">
                  Rehabilitation
                </Link>
              </NavDropdown.Item>
              <NavDropdown.Divider />
              <NavDropdown.Item eventKey={29}>
                <Link to="/rehabilitationpage/rehabspotinjuriesform">
                  Sport Injuries
                </Link>
              </NavDropdown.Item>
              <NavDropdown.Divider />
              <NavDropdown.Item eventKey={30}>
                <Link to="/rehabilitationpage/rehabconcussionrtpform">
                  Concussion - RTP
                </Link>
              </NavDropdown.Item>
              <NavDropdown.Divider />
              <NavDropdown.Item eventKey={31}>
                <Link to="/rehabilitationpage/rehabconcussionrtlform">
                  Concussion - RTL
                </Link>
              </NavDropdown.Item>
              <NavDropdown.Divider />
              <NavDropdown.Item eventKey={32}>
                <Link to="/rehabilitationpage/rehabsportmassageform">
                  Sport Massage
                </Link>
              </NavDropdown.Item>
            </NavDropdown>
            ...
            <NavDropdown title="Rates" id="collasible-nav-dropdown">
              <NavDropdown.Item eventKey={38}>
                <Link to="/ratespage/ratesform">All Rates</Link>
              </NavDropdown.Item>
              <NavDropdown.Divider />
              <NavDropdown.Item eventKey={39}>
                <Link to="/ratespage/rateweightlossform">Weight Loss</Link>
              </NavDropdown.Item>
              <NavDropdown.Divider />
              <NavDropdown.Item eventKey={40}>
                <Link to="/ratespage/raterehabilitationform">
                  Rehabilitation
                </Link>
              </NavDropdown.Item>
              <NavDropdown.Divider />
              <NavDropdown.Item eventKey={41}>
                <Link to="/ratespage/ratephotographyform">Photography</Link>
              </NavDropdown.Item>
              <NavDropdown.Divider />
              <NavDropdown.Item eventKey={42}>
                <Link to="/ratespage/ratecoachingindividuelform">
                  Coaching/Strapping/Sport Massage - Individuel
                </Link>
              </NavDropdown.Item>
              <NavDropdown.Divider />
              <NavDropdown.Item eventKey={43}>
                <Link to="/ratespage/ratecoachinggroupform">
                  Coaching - Group
                </Link>
              </NavDropdown.Item>
              <NavDropdown.Divider />
              <NavDropdown.Item eventKey={44}>
                <Link to="/ratespage/ratecoachinggeneralfitnessform">
                  Coaching - General Fitness
                </Link>
              </NavDropdown.Item>
              <NavDropdown.Divider />
              <NavDropdown.Item eventKey={45}>
                <Link to="/ratespage/ratecoachingsportspecificform">
