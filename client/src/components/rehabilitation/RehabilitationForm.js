    ...
    <div className="container">
      <Media>
        <Media.Body>
          ...
          <sub><a href="https://www.webmd.com/" target="blank">Info from WebMD</a></sub>
          <p>
            The most common and least serious type of traumatic brain injury is called a
            concussion. The word comes from the Latin concutere, which means &quot;to shake
            violently.&quot;A concussion is most often caused by a sudden direct
            blow or bump to the head.
          </p>
          <p>
            According to the CDC, between 2001 and 2009, an estimated 173,285 people under
            age 19 were treated in hospital emergency rooms for concussions related to sports
            and recreation activities. Other causes include car and bicycle accidents,
            work-related injuries, falls, and fighting.
          </p>
        </Media.Body>
      </Media>
      <Media>
      ...
      <ListGroup as="ul">
        ...
        <ListGroup.Item as="li">Trouble with hearing, smell, taste</ListGroup.Item>
